import{f as b,a as k,b as h,i as c}from"./assets/burger-bbdefd62.js";import"./assets/vendor-77e6b4aa.js";const i="/js_92_Runners-of-code/assets/books-102aefcf.png",r=document.querySelector(".books-card"),l=document.querySelector(".book-massage"),p=document.querySelector(".header-shopping"),u=document.querySelector(".header-home"),s=JSON.parse(localStorage.getItem("An_array_of_ID_books"));let n=s.length;u.classList.remove("active-button");p.classList.add("active-button");async function v(){if(s&&s.length>0)for(const a of s)try{const o=await b(a);console.log(o);const t=`
